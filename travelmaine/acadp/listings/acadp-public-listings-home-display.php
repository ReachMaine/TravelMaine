...
/**
 * This template displays the ACADP listings in home view.
 * zig - 7jun19 create home view, 4 columsn no divider
 *
 */
?>

<div class="acadp acadp-listings acadp-home-view">
	...
	<!-- zig <div class="acadp-divider"></div> -->

	<!-- the loop -->
    <div class="acadp-body">
		<?php
            $columns = 4; //zig always 4 for home view $listings_settings['columns'];
