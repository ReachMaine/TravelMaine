...
add_shortcode( "acadp_listings_pets", "run_shortcode_listings_pets" );


function run_shortcode_listings_pets( $atts ) {
		$shortcode = 'acadp_listings_pets';
		...
		$meta_queries = array();
		// setup to only look for pet friendly
		$meta_queries['pets'] = array(
			'key'     => '29',
			'value'   => 'yes',
			'compare' => '='
		);
		...
		//echo "<pre>";var_dump($acadp_query); echo "</pre>";		// Start the Loop
		global $post;
